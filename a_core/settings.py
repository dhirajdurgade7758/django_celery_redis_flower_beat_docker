...
ALLOWED_HOSTS = ['localhost', '127.0.0.1','app-production-8204.up.railway.app']

CSRF_TRUSTED_ORIGINS = [ 'https://app-production-8204.up.railway.app' ]
...
ACCOUNT_SIGNUP_FIELDS = ['email*', 'username*', 'password1*', 'password2*']  # ✅ recommended
